...
if __name__ == '__main__':
	...
	print("Using model directory:", model.directory)
	print()
...
#	model.to_oxcal()
#	model.save(zipped = True)
#	model.process_randomization(max_cpus = max_cpus, max_queue_size = max_queue_size)
#	model.save(zipped = True)
#	model.process_clustering(max_cpus = max_cpus, max_queue_size = max_queue_size)
...
#	model.save(zipped = True)
	model.plot_randomized(show = True)
	model.plot_clusters(show = True)
#	model.save_outliers()
#	model.save_csv()
